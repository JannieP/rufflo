...
beforeEach(() => {
  ...
  process.env.CLAUDE_FLOW_MEMORY_PATH = dir; // isolated, fresh store
});
afterEach(() => {
  if (prev === undefined) delete process.env.CLAUDE_FLOW_MEMORY_PATH;
  else process.env.CLAUDE_FLOW_MEMORY_PATH = prev;
